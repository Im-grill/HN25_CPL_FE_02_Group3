...
function ProductDetail() {
    ...
    const renderProductCard = (product: Product) => {
        return (
            <div key={product.id}
                 className="relative flex flex-col w-40 border border-gray-200 rounded-md overflow-hidden hover:shadow-md transition">
                {product.isAd && (
                            ...
                            <div className="flex items-center mt-4 text-sm ml-6">
                                ...
                                <div className="text-right ml-auto mr-3">
                                    <img
                                        ...
                                        alt="icon-right" width="24" height="24"></img>
                                </div>
                            </div>
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6 mt-4">
                            ...
                            <div className={`relative overflow-hidden ${expanded ? 'h-auto' : 'h-64'}`}>
                                <p className="whitespace-pre-line leading-relaxed text-gray-700">
                                    ...
                                    Quyển sách "Kitty Language: An Illustrated Guide to Understanding Your Cat" - quyển
                                    sách "đọc vị" loài mèo đình đám trong hội con sen toàn thế giới nay đã chính thức có
                                    phiên bản Việt hóa với tên: "Mèo méo meo - Bí mật giao tiếp từ cái vẫy đuôi đến
                                    tiếng grừ grừ". Quyển sách nhận được 4.6 sao trên sàn Amazon và trở thành quyển cẩm
                                    nang đặc biệt giúp "sen" kết nối với "quàng thượng" theo một cách vừa khoa học, vừa
                                    gần gũi. Những hình minh họa đáng yêu từ tác giả Lili Chin sẽ giúp bạn thấu hiểu
                                    "ngôn ngữ" của boss yêu qua mọi bộ phận cơ thể: mặt, mắt, tai, râu và đuôi; và cả
                                    cách thay đổi tư thế hay hướng và tốc độ di chuyển.
                                    Để chào đón "hội sen Việt Nam", Saigon Books còn dành tặng bộ quà tặng đặc biệt: Thẻ
                                    đeo mica dành cho boss yêu cùng Decal Sticker cute của nhà Vitamin Mèo.

                                    Quyển sách được chắp bút và minh họa bởi Lili Chin - nghệ sĩ minh họa nổi tiếng và
                                    là "con sen" chính hiệu. Cô đã hợp tác với nhiều tổ chức uy tín như Fear Free Pets,
                                    RSPCA, Hiệp hội tư vấn hành vi động vật quốc tế và International Cat Care. Cô cũng
                                    là tác giả của quyển sách "Doggie Language" đình đám.
                                ...
                                {!expanded && (
                                    <div
                                        className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-white to-transparent"></div>
                                )}
                            </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start border-b border-gray-200 pb-2">
                                    <img
                                        ...
                                        alt="compensation-icon" height="20" width="20"/>
