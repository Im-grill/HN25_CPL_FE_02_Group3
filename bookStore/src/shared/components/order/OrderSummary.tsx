...
const OrderSummary: React.FC<OrderSummaryProps> = ({
    ...
    return (
        <div className="bg-white rounded-md w-full max-w-full overflow-hidden">
            <div className="p-3 sm:p-3.5 md:p-4 leading-5 border-b border-[#ebebf0]">
                ...
                <div className="flex items-center flex-wrap">
                    ...
                    <div className="flex items-center">
                        <p className="text-xs sm:text-sm md:text-sm text-[rgb(11,116,229)] font-normal">Xem thông tin</p>
                        <svg
                            className="sub-title-link__arrow transform rotate-[90deg] transition-all duration-500 w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5"
                            width="20"
                            height="20"
                            viewBox="0 0 24 24"
                            fill="none"
            ...
            <div className="p-2 sm:p-3 md:p-4 grid gap-2 text-xs sm:text-xs md:text-sm leading-[18px] md:leading-[21px]">
                ...
                <div className="flex justify-between gap-x-2 sm:gap-x-4">
                    ...
                    <span className="text-right">{shippingFee.toLocaleString('vi-VN')}</span>
                </div>
                <div className="flex justify-between gap-x-2 sm:gap-x-4">
                    <span className="text-[rgb(128,128,137)]">Giảm giá trực tếp</span>
                    <span className="text-[rgb(0,171,86)] text-right">
            ...
            <div className="p-2 sm:p-3 md:p-4 flex justify-between items-center">
                ...
                <div className="flex flex-col items-end">
                    <span className="text-[rgb(255,66,78)] font-semibold text-base sm:text-lg md:text-xl leading-tight">
                        {totalPayment.toLocaleString('vi-VN')}
                    </span>
                    <span className="text-[rgb(0,171,86)] text-[10px] sm:text-xs md:text-sm">
            ...
            {error && <div className="text-red-500 px-2 sm:px-3 md:px-4 pb-2 text-xs sm:text-xs md:text-sm">{error}</div>}
